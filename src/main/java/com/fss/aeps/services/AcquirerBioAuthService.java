...
import com.fss.aeps.repository.AcquirerRepositories.AcquirerBioAuthRepository;
...
@Service
public class AcquirerBioAuthService {

	@Autowired
	private AcquirerBioAuthRepository repositiry;

	public AcquirerBioAuth populateRequestData(AcquirerBioAuth transaction, ReqBioAuth request) {
	...
	public AcquirerBioAuth registerTransactionRequest(AcquirerBioAuth transaction, ReqBioAuth request) {
		populateRequestData(transaction, request);
		return repositiry.save(transaction);
	}

	public AcquirerBioAuth registerTransactionResponse(AcquirerBioAuth transaction, RespBioAuth response) {
		if(response != null) {
