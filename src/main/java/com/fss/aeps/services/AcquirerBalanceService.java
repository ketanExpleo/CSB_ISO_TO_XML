...
import com.fss.aeps.repository.AcquirerRepositories.AcquirerBalanceRepository;
...
@Service
public class AcquirerBalanceService {

	@Autowired
	private AcquirerBalanceRepository repositiry;

	public AcquirerBalanceEnquiry populateRequestData(AcquirerBalanceEnquiry transaction, ReqBalEnq request) {
	...
	public AcquirerBalanceEnquiry registerTransactionRequest(AcquirerBalanceEnquiry transaction, ReqBalEnq request) {
		populateRequestData(transaction, request);
		return repositiry.save(transaction);
	}

	public AcquirerBalanceEnquiry registerTransactionResponse(AcquirerBalanceEnquiry transaction, RespBalEnq response) {
		if(response != null) {
