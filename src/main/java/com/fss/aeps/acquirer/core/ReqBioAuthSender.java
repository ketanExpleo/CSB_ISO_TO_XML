...
import com.fss.aeps.services.AcquirerBioAuthService;

import reactor.core.publisher.Mono;

@Component
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class ReqBioAuthSender implements IAcquirerTransaction<ReqBioAuth, RespBioAuth>{
	...
	@Autowired
	private AcquirerBioAuthService bioAuthService;

	private final AcquirerBioAuth transaction = new AcquirerBioAuth();
	...
	public RespBioAuth send(ReqBioAuth request) {
		...
		try {
			...
			bioAuthService.populateRequestData(transaction, request);
