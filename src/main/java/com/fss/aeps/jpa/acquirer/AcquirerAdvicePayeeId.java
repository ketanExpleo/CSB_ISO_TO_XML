...
@Embeddable
public class AcquirerAdvicePayeeId implements Serializable {
	...
	public AcquirerAdvicePayeeId() {
	}

	public AcquirerAdvicePayeeId(String msgId, String seqnum) {
		this.msgId = msgId;
		this.seqnum = seqnum;
	}
	...
	public boolean equals(Object obj) {
		...
		if ((obj == null) || (getClass() != obj.getClass()))
			return false;
		AcquirerAdvicePayeeId other = (AcquirerAdvicePayeeId) obj;
