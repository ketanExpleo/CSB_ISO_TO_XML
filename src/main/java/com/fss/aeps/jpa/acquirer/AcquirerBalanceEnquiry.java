...
// Generated 25-Aug-2022, 7:39:18 pm by Hibernate Tools 4.3.6.Final
...
@DynamicUpdate
@Entity
@Table(name = "ACQUIRER_BALANCE_ENQUIRY")
public class AcquirerBalanceEnquiry implements Serializable, Persistable<String> {
