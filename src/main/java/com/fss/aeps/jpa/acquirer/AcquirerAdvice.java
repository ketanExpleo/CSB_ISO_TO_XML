...
@Entity
@Table(name = "ACQUIRER_ADVICE")
public class AcquirerAdvice implements Serializable, Persistable<String> {
	...
	public AcquirerAdvice() {
	}

	public AcquirerAdvice(String msgId, String txnId, PayConstant txnType) {
		this.msgId = msgId;
		this.txnId = txnId;
	...
	@Column(name = "ORG_RESP_CODE", length = 3)
