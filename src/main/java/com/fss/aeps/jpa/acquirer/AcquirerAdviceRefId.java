...
@Embeddable
public class AcquirerAdviceRefId implements Serializable {
	...
	public AcquirerAdviceRefId() {
	}

	public AcquirerAdviceRefId(String msgId, String seqnum, RefType type) {
		this.msgId = msgId;
		this.seqnum = seqnum;
		this.type = type;
	}
	...
	public boolean equals(Object obj) {
		...
		if ((obj == null) || (getClass() != obj.getClass()))
			return false;
		AcquirerAdviceRefId other = (AcquirerAdviceRefId) obj;
