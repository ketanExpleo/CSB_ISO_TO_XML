...
public class AcquirerTransaction implements Serializable, Persistable<String> {
	...
	private Set<AcquirerTransactionRef> refs = new HashSet<>(0);
	private Set<AcquirerTransactionPayee> payees = new HashSet<>(0);
	...
	public void setPayerCredType(CredType payerCredType) {
		this.payerCredType = payerCredType;
	}
	...
	@Column(name = "REF_RESP_CODE", length = 3)
	...
	@Column(name = "RESP_UIDAI_ERROR", length = 20)
	public String getRespUidaiError() {
		return this.respUidaiError;
	}

	public void setRespUidaiError(String respUidaiError) {
		this.respUidaiError = respUidaiError;
	}
	...
	@Column(name = "UIDAI_TOKEN", length = 100)
	public String getUidaiToken() {
		return this.uidaiToken;
	}

	public void setUidaiToken(String uidaiToken) {
		this.uidaiToken = uidaiToken;
	}
	...
	@OneToMany(fetch = FetchType.EAGER, mappedBy = "transaction", cascade = {CascadeType.PERSIST, CascadeType.MERGE})
	public Set<AcquirerTransactionRef> getRefs() {
		return this.refs;
	}

	public void setRefs(Set<AcquirerTransactionRef> refs) {
		this.refs = refs;
	}

	@OneToMany(fetch = FetchType.EAGER, mappedBy = "transaction", cascade = CascadeType.PERSIST)
	public Set<AcquirerTransactionPayee> getPayees() {
		return this.payees;
	}

	public void setPayees(Set<AcquirerTransactionPayee> payees) {
		this.payees = payees;
	}
