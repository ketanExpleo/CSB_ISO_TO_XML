...
@Embeddable
public class AcquirerReversalRefId implements Serializable {
	...
	public AcquirerReversalRefId() {
	}

	public AcquirerReversalRefId(String msgId, String seqnum, RefType refType) {
		this.msgId = msgId;
		this.seqnum = seqnum;
		this.type = refType;
	}
	...
	public boolean equals(Object obj) {
		...
		if ((obj == null) || (getClass() != obj.getClass()))
			return false;
		AcquirerReversalRefId other = (AcquirerReversalRefId) obj;
