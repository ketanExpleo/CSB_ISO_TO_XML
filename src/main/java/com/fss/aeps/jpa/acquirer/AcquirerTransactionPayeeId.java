...
@Embeddable
public class AcquirerTransactionPayeeId implements Serializable {
	...
	public AcquirerTransactionPayeeId() {
	}

	public AcquirerTransactionPayeeId(String msgId, String seqnum) {
		this.msgId = msgId;
		this.seqnum = seqnum;
	}
	...
	public boolean equals(Object other) {
		if ((this == other))
			return true;
		if ((other == null) || !(other instanceof AcquirerTransactionPayeeId))
			return false;
		AcquirerTransactionPayeeId castOther = (AcquirerTransactionPayeeId) other;
