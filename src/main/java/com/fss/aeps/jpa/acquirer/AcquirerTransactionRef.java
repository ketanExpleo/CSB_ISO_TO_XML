...
@DynamicInsert
@Entity
@Table(name = "ACQUIRER_TRANSACTION_REF")
public class AcquirerTransactionRef implements Serializable, Persistable<AcquirerTransactionRefId> {
	...
	private AcquirerTransactionRefId id;
	...
	public AcquirerTransactionRefId getId() {
		return this.id;
	}

	public void setId(AcquirerTransactionRefId id) {
		this.id = id;
	}
