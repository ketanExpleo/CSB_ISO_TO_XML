...
@DynamicUpdate
@Entity
@Table(name = "ISSUER_TRANSACTION")
public class IssuerTransaction implements Serializable, Persistable<String> {
	...
	private Set<IssuerTransactionPayee> payees = new HashSet<>(0);
	private Set<IssuerTransactionRef> refs = new HashSet<>(0);

	public IssuerTransaction() {
	}
	...
	@Column(name = "RISK_PROVIDER", length = 20)
	public String getRiskProvider() {
		return this.riskProvider;
	}

	public void setRiskProvider(String riskProvider) {
	...
	@Column(name = "RISK_VALUE", length = 8)
	...
	public Set<IssuerTransactionPayee> getPayees() {
		return payees;
	}

	public void setPayees(Set<IssuerTransactionPayee> payees) {
		this.payees = payees;
	}

	@OneToMany(fetch = FetchType.LAZY, mappedBy = "transaction", cascade = CascadeType.PERSIST)
	public Set<IssuerTransactionRef> getRefs() {
		return refs;
	}

	public void setRefs(Set<IssuerTransactionRef> refs) {
		this.refs = refs;
	}
