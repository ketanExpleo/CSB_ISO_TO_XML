...
// Generated 22-Aug-2022, 1:18:28 pm by Hibernate Tools 4.3.6.Final
...
@DynamicInsert
@Entity
@Table(name = "ISSUER_ADVICE_REF")
public class IssuerAdviceRef implements Serializable {
	...
	private IssuerAdviceRefId id;
	private IssuerAdvice advice;
	private String addr;
	...
	public IssuerAdviceRefId getId() {
		return this.id;
	}

	public void setId(IssuerAdviceRefId id) {
		this.id = id;
	}

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "MSG_ID", nullable = false, insertable = false, updatable = false)
	public IssuerAdvice getAdvice() {
		return this.advice;
	}

	public void setAdvice(IssuerAdvice advice) {
		this.advice = advice;
	}
