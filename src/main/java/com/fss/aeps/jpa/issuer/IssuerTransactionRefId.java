...
@Embeddable
public class IssuerTransactionRefId implements Serializable {
	...
	public IssuerTransactionRefId() {
	}

	public IssuerTransactionRefId(String msgId, RefType type, String seqnum) {
		this.msgId = msgId;
		this.type = type;
		this.seqnum = seqnum;
	}
	...
	public boolean equals(Object obj) {
		...
		IssuerTransactionRefId other = (IssuerTransactionRefId) obj;
