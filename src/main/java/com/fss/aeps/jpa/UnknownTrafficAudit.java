...
@DynamicUpdate
@Entity
@Table(name = "UNKNOWN_TRAFFIC_AUDIT")
public class UnknownTrafficAudit implements TrafficAudit {
	...
	public UnknownTrafficAudit() {
	}

	public UnknownTrafficAudit(long id) {
		this.id = id;
	}
	...
	@Override
	@Column(name = "CONTEXT_PATH", length = 2048)
